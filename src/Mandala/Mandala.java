...
public class Mandala {
    ...
    private void calcularPontos(){
        ...
        this.ponto7 = (new Ponto(ponto1.getX(), (ponto1.getY() - (2 * diferencaXY))));//distanciaY // (2 * distancia)
        ...
        this.ponto13 = (new Ponto(ponto1.getX(), (ponto1.getY() + (2 * diferencaXY))));//distanciaY // (2 * distancia)
    }
